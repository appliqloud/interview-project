...
from pynamodb.attributes import UnicodeAttribute, UTCDateTimeAttribute, NumberAttribute, MapAttribute, ListAttribute, BooleanAttribute
...
class ProductTranslation(MapAttribute):
